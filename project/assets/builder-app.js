    ...
    switch (b.type) {
      ...
      case "postgrid":
        return "<section style='padding:48px 0'><div class='wrap'><h2 style='font-size:26px;margin-bottom:24px'>" + esc(p.heading) + "</h2><div class='grid' style='display:grid;grid-template-columns:repeat(" + p.columns + ",1fr);gap:20px'>" +
          ...
          (p.showExcerpt ? "<b:if cond='data:post.snippet'><p style='color:#828aa0;font-size:14px;margin-top:8px;line-height:1.5;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden'><data:post.snippet/></p></b:if>" : "") +
          "</div></article></b:loop>" +
          "</div></div></section>";
      case "postlist":
