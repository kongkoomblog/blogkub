    ...
    switch (b.type) {
      ...
      case "postgrid":
        return "<section style='padding:48px 0'><div class='wrap'><h2 style='font-size:26px;margin-bottom:24px'>" + esc(p.heading) + "</h2><div class='grid' style='display:grid;grid-template-columns:repeat(" + p.columns + ",1fr);gap:20px'>" +
          ...
          (p.showExcerpt ? "<p style='color:#828aa0;font-size:14px;margin-top:8px;line-height:1.5;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden'><b:eval expr='data:post.metaDescription ?: data:post.snippet'/></p>" : "") +
          "</div></article></b:loop>" +
          "</div></div></section>";
      case "postlist":
        return "<section style='padding:48px 0'><div class='wrap'><h2 style='font-size:26px;margin-bottom:20px'>" + esc(p.heading) + "</h2><b:loop values='data:posts' var='post'><article style='display:flex;gap:16px;border-bottom:1px solid #eef;padding:16px 0'>" +
          ...
          "<div style='min-width:0'><h3 style='font-size:17px;margin:0 0 6px'><a expr:href='data:post.url'><data:post.title/></a></h3><p style='color:#828aa0;font-size:13px;margin:0;line-height:1.5;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden'><b:eval expr='data:post.metaDescription ?: data:post.snippet'/></p></div></article></b:loop></div></section>";
      case "featured":
