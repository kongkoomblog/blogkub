...
".rv-card-best{position:absolute;top:17px;left:-38px;width:150px;z-index:3;transform:rotate(-45deg);text-align:center;font-size:10px;font-weight:800;letter-spacing:.07em;line-height:1.35;text-transform:uppercase;padding:6px 0;color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;background:linear-gradient(135deg,var(--primary)9e,var(--accent)70);-webkit-backdrop-filter:blur(9px) saturate(1.6);backdrop-filter:blur(9px) saturate(1.6);box-shadow:0 3px 12px rgba(0,0,0,.15),inset 0 1px 0 rgba(255,255,255,.32),inset 0 -1px 0 rgba(255,255,255,.16);text-shadow:0 1px 3px rgba(0,0,0,.4);transition:background .25s}",
".rv-card:hover .rv-card-best{background:linear-gradient(135deg,var(--primary)d4,var(--accent)b0)}",
"@supports not ((backdrop-filter:blur(2px)) or (-webkit-backdrop-filter:blur(2px))){.rv-card-best{background:linear-gradient(135deg,var(--primary)cc,var(--accent)b3)}}",
